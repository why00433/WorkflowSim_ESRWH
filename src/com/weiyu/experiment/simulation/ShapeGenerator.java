...
import com.weiyu.experiment.simulation.connection.Connection;
import com.weiyu.experiment.simulation.connection.ConnectionFactory;
import com.weiyu.experiment.simulation.data.DataFactor;
import com.weiyu.experiment.simulation.data.DataFactorFactory;
import com.weiyu.experiment.simulation.shape.Shape;
import com.weiyu.experiment.simulation.shape.ShapeFactory;
...
public class ShapeGenerator {
    ...
    public void generateWorkflow(int numJobs, int numFiles, int depth)
        ...
        String fileName = "Random_" + numJobs + "_" + numFiles + "_" + depth + ".xml";
        this.dax.toXML(new OutputStreamWriter(new FileOutputStream(new File(fileName))), "", null);
    }
