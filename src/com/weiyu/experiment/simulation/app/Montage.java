...
public class Montage extends AbstractApplication {
    ...
    private static int MIN_INPUTS = 3;
    ...
    protected void processArgs(String[] args) {
        ...
        while ((c = g.getopt()) != -1) {
            switch (c) {
                ...
                case 'f':
                	double generatedDouble = generateDouble("mProjectPP_mean");
                    this.runtimeFactor = Double.parseDouble(g.getOptarg()) / generatedDouble;
                    System.out.println("generatedDouble:" + generatedDouble + "-runtimeFactor:" + runtimeFactor);
                    break;
