...
public class Vm {
	...
	public String toString() {
		return "Vm [id=" + id + ", userId=" + userId + ", uid=" + uid + ", size=" + size + ", mips=" + mips
				+ ", numberOfPes=" + numberOfPes + ", ram=" + ram + ", bw=" + bw + ", vmm=" + vmm
				+ ", cloudletScheduler=" + cloudletScheduler + ", host=" + host + ", inMigration=" + inMigration
				+ ", currentAllocatedSize=" + currentAllocatedSize + ", currentAllocatedRam=" + currentAllocatedRam
				+ ", currentAllocatedBw=" + currentAllocatedBw + ", currentAllocatedMips=" + currentAllocatedMips
				+ ", beingInstantiated=" + beingInstantiated + ", stateHistory=" + stateHistory + "]";
	}
