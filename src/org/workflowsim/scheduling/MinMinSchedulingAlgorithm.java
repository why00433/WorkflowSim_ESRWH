...
//            System.out.println("任务ID： " + minCloudlet.getCloudletId() +
//            		" 任务大小： " + minCloudlet.getCloudletLength() + "匹配的VM id:" + minCloudlet.getVmId() + " 任务输出大小： " + minCloudlet.getCloudletOutputSize() + 
//            		 " 资源名称：" + minCloudlet.getResourceName(minCloudlet.getResourceId()));
        }
    }
}
