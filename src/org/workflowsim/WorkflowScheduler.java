...
public class WorkflowScheduler extends DatacenterBroker {
    ...
    protected void processCloudletUpdate(SimEvent ev) {
        ...
        scheduler.setDatacenterList(getDatacenterList());
        scheduler.setDatacenterIdsList(getDatacenterRequestedIdsList());
     ...
     * @param datacenter
     */
	public void submitDatacenters(Datacenter datacenter) {
		if (datacenter == null) {
            Log.printLine("Empty data center");
            return;
        }
