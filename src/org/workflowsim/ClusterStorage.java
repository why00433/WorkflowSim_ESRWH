...
public class ClusterStorage extends HarddriveStorage {
	...
	public String toString() {
		return "ClusterStorage [bandwidthMap=" + bandwidthMap + ", getName()=" + getName() + ", getMaxTransferRate()="
				+ getMaxTransferRate() + ", getFileNameList()=" + getFileNameList() + ", BandwidthIn= " + getMaxBandwidth("in") + ", BandwidthBetween=" + getMaxBandwidth("between") +"]";
	}
