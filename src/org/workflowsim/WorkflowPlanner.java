 ...
 *
 */
public final class WorkflowPlanner extends DatacenterBroker {
     ...
     * 工作流应用集合
     */
    protected List<List<Task>> workflowList;
    /**
     * The workflow parser.
     */
    ...
    public void processEvent(SimEvent ev) {
        switch (ev.getTag()) {
            case WorkflowSimTags.START_SIMULATION:
            	WorkflowParser parse = getWorkflowParser();
            	parse.parse();
                setTaskList(parse.getTaskList());
                setWorkflowList(parse.getWorkflowList());
                processPlanning();
    ...
    private void processPlanning() {
        ...
        planner.setWorkflowList(workflowList);
//        planner.setVmList(getVmsCreatedList());
//        planner.setDatacenterList(getDatacenterList());
        planner.setVmList(getWorkflowEngine().getAllVmList());
        planner.setDatacenterList(getWorkflowEngine().getAllDatacenterList());
        planner.setDatacenterIdsList(getWorkflowEngine().getAllDatacenterIdsList());
        try {
            planner.run();
        } catch (Exception e) {
